...
const WALKABLE_RECTS: Array[Rect2] = [
    Rect2(Vector2(-560, 78), Vector2(1120, 36)),
    Rect2(Vector2(-506, 42), Vector2(36, 72)),
    Rect2(Vector2(-218, -54), Vector2(36, 168)),
    Rect2(Vector2(126, 78), Vector2(36, 144)),
    Rect2(Vector2(462, -90), Vector2(36, 204)),
]
